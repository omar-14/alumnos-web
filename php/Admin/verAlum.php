...
<div>
    ...
    $sql = "SELECT usuario FROM alumno WHERE id_usuario = $id_usuario";
    ...
    $resUsuario = mysqli_query($conexion, $sql);
    $informacion = mysqli_fetch_row($resGenAlumno);
    $boleta = mysqli_fetch_row($resUsuario);
    ...
    ?> 
            <form id="formAdmi">    
                <div class="row ">
                    <h4 class="center-align" style="color: #006699"><?php echo $boleta[0]; ?></h4>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m6">
                        <select class="browser-default" id="numPrograma" name="numPrograma" required>
                            <option value="<?php echo $informacion[24];?>"><?php echo $tipoSemestre;?></option>
                    ...
                    <div class="col s12 m6 input-field" >
                        <select class="browser-default" id="semestre" name="semestre" required >
                            <option value="<?php echo $informacion[25];?>"><?php echo $numProgSelec;?></option>
