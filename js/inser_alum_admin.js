$(document).ready(function(){
    ...
    $("#formAdmiAlum").validetta({
        ...
        onValid:function(e){
            ...
            let grupo = $("#grupo").val();
            $.ajax({
                url:"./regis_Alum_ins.php",
                method:"POST",
                data:{usuario:usuario, contrasena:contrasena, curp:curp, nombre:nombre, primerApe:primerApe, segundoApe:segundoApe, fechaNaci:fechaNaci, genero:genero, email:email, telFijo:telFijo, telCelu:telCelu, calle:calle, num:num, colonia:colonia, alcaMun:alcaMun, estado:estado, tipoEsc:tipoEsc, nomEsc:nomEsc, localidad:localidad, formacion:formacion, promedio:promedio, programa:programa, semestre:semestre, numPrograma:numPrograma, grupo:grupo},
                cache:false,
                success:function(respAX){
